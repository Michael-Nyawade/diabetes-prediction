...
This project applies exploratory data analysis (EDA), feature engineering, and machine learning to predict the likelihood of diabetes using health-related attributes. The goal is to build a predictive model and extract meaningful insights that align with known medical risk factors.

The analysis is performed in Python using Jupyter Notebook and leverages the publicly available **[Pima Indians Diabetes dataset](https://www.kaggle.com/datasets/uciml/pima-indians-diabetes-database)**, commonly used for research, analytics, and educational purposes.
